...
spark = SparkSession.builder\
                    .config('spark.jars', '/home/aekanun2020/gcs-connector-hadoop3-latest.jar')\
                    .getOrCreate()

spark._jsc.hadoopConfiguration().set('fs.gs.impl', 'com.google.cloud.hadoop.fs.gcs.GoogleHadoopFileSystem')

from pyspark.ml.pipeline import PipelineModel as pl
loaded_model = pl.load('gs://oct22-23/refinedzone/ArrDelay_regressionModel')
...
class MakePrediction(Resource):
	...
	airline_row_df = spark.sparkContext.parallelize(raw_list).toDF()
